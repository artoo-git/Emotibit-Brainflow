...
class Graph:
    def __init__(self, board_shim):
        ...
        self.update_speed_ms = 50  # Reduced to 20 FPS for better CPU usage
        self.window_size = 4
        ...
        self.win = pg.GraphicsLayoutWidget(show=True, title='EmotiBit IMU Data')
